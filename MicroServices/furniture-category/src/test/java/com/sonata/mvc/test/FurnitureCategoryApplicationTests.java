...
//@SpringBootTest(classes=com.example.demo.FurnitureProductApplicationTests.class)
//@EnableJpaRepositories(basePackages = "com.sonata.mvc.repository")
//@ComponentScan(basePackages = "com.netsurfingzone.*")
//@EntityScan("com.sonata.*")

//@ComponentScan("com.sonata.mvc.repository")
@DataJpaTest
@AutoConfigureTestDatabase(replace = AutoConfigureTestDatabase.Replace.NONE)
public class FurnitureCategoryApplicationTests {
	
	@Autowired
	public CategoryRepository prep;
	//@Autowired
  ...
  List<Category> products = prep.findAll();
  	...
  	public void testCreate () {
    	Category p = new Category();
  		p.setCategoryID(0);
  		p.setCategoryName("Chairs");
  		p.setCategoryImage("https://www.ulcdn.net/images/products/334899/slide/666x363/Owen_Lounge_Chair_Mustard_Yellow_5.jpg?1619007579");
